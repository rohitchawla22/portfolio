    ...
    >
      ...
      {!tag && (
        <p className="text-fun-gray text-xl sm:text-2xl max-w-3xl m-auto">
          I've worked on some cool apps, websites and API's using anything from PHP to Typescript
          (and even Elixir!). Here are some of my favorite projects over the course
          of my journey.
        </p>
      )}
    </div>
